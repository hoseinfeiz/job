    ...
    <Global
      styles={css`
        ...
        @font-face {
          ...
          src:
            url('./font/Shabnam.eot?#iefix') format('embedded-opentype'),
        ...
        @font-face {
          ...
          src:
            url('./font/Shabnam-Bold.eot?#iefix') format('embedded-opentype'),
        ...
        @font-face {
          ...
          src:
            url('./font/Shabnam-Thin.eot?#iefix') format('embedded-opentype'),
        ...
        @font-face {
          ...
          src:
            url('./font/Shabnam-Light.eot?#iefix') format('embedded-opentype'),
        ...
        @font-face {
          ...
          src:
            url('./font/Shabnam-Medium.eot?#iefix') format('embedded-opentype'),
